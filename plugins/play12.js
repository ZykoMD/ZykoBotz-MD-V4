...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://wa.me/12136852040' },
...
body: wm,
sourceUrl: 'http://wa.me/12136852040', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
...
handler.help = ['play1'].map(v => v + ' <pencarian>')
