...
let handler = async (m, { conn, command, text }) => {
  ...
  let sindirani = pickRandom(global.sindiran)
  let flaa = pickRandom(global.flaaaaa)
await conn.sendButton(m.chat, `${sindirani}\n`,wm + '\n\n' + botdate, `${flaa}sindiran`, [['NEXT','.sindiran']], m, {
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        ...
                        thumbnail: await (await fetch('https://telegra.ph/file/125071027ea0bac4b32f3.jpg')).buffer(),
